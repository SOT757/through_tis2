...
##Pmod Header JA (XADC)
set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports tx_mclk]
set_property -dict {PACKAGE_PIN L14 IOSTANDARD LVCMOS33} [get_ports tx_lrck]
set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33} [get_ports tx_sclk]
set_property -dict {PACKAGE_PIN K14 IOSTANDARD LVCMOS33} [get_ports tx_data]
set_property -dict {PACKAGE_PIN N16 IOSTANDARD LVCMOS33} [get_ports rx_mclk]
set_property -dict {PACKAGE_PIN L15 IOSTANDARD LVCMOS33} [get_ports rx_lrck]
set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS33} [get_ports rx_sclk]
set_property -dict {PACKAGE_PIN J14 IOSTANDARD LVCMOS33} [get_ports rx_data]
