...
HD_PWD='C:/Vivado/i2s2/i2s2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log separate_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source separate_tb.tcl
