...
HD_PWD='C:/Vivado/i2s2/i2s2.runs/design_1_axis_volume_controll_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axis_volume_controll_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axis_volume_controll_0_0.tcl
